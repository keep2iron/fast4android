 ...
 * @date 2018/10/30
 */
class WebviewActivity : AbstractActivity<ViewDataBinding>() {
    ...
    override fun initVariables(savedInstanceState: Bundle?) {
        val bufferedReader = BufferedReader(InputStreamReader(assets.open("index.html")))
        var line: String?
...
//        val doc = builder.parse(assets.open("index.html"))
//        val html = doc.documentElement.childNodes.item(0)
//
//        val node = DocumentBuilderFactory
//                .newInstance()
//                .newDocumentBuilder()
//                .parse(ByteArrayInputStream(content.toByteArray()))
//                .documentElement

//        for (i in 0 until html.childNodes.length) {
//            val item = html.childNodes.item(i)
//            if ("body" == item.nodeName) {
//                item.appendChild(node)
//            }
//        }
//
//        val textContent = toString(doc)
