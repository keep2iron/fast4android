...
import static io.github.keep2iron.app.widget.MaterialMenuDrawable.DEFAULT_COLOR;
import static io.github.keep2iron.app.widget.MaterialMenuDrawable.DEFAULT_SCALE;
import static io.github.keep2iron.app.widget.MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION;
import static io.github.keep2iron.app.widget.MaterialMenuDrawable.DEFAULT_VISIBLE;
...
public class MaterialMenuView extends View implements MaterialMenu {
    ...
    @Override public void setIconState(MaterialMenuDrawable.IconState state) {
        currentState = state;
        drawable.setIconState(state);
    }

    @Override public MaterialMenuDrawable.IconState getIconState() {
        return drawable.getIconState();
    }

    @Override public void animateIconState(MaterialMenuDrawable.IconState state) {
        currentState = state;
