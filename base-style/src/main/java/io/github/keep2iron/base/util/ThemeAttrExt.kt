...
fun TextView.assignTextViewWithAttr(attrRes: Int) {
    ...
    for (i in 0 until count) {
        ...
        when (attr) {
            ...
            R.styleable.FastTextCommonStyleDef_android_textSize -> setTextSize(
                    TypedValue.COMPLEX_UNIT_PX,
                    a.getDimensionPixelSize(attr, 0).toFloat()
            )
            R.styleable.FastTextCommonStyleDef_android_paddingLeft -> paddingLeft =
                    a.getDimensionPixelSize(attr, 0)
            R.styleable.FastTextCommonStyleDef_android_paddingRight -> paddingRight =
                    a.getDimensionPixelSize(attr, 0)
            R.styleable.FastTextCommonStyleDef_android_paddingTop -> paddingTop =
                    a.getDimensionPixelSize(attr, 0)
            R.styleable.FastTextCommonStyleDef_android_paddingBottom -> paddingBottom =
                    a.getDimensionPixelSize(attr, 0)
            R.styleable.FastTextCommonStyleDef_android_singleLine -> setSingleLine(
                    a.getBoolean(
                            attr,
                            false
                    )
            ...
            R.styleable.FastTextCommonStyleDef_android_background -> setBackgroundKeepingPadding(
                    a.getDrawable(
                            attr
                    )
            )
            R.styleable.FastTextCommonStyleDef_android_lineSpacingExtra -> setLineSpacing(
                    a.getDimensionPixelSize(
                            attr,
                            0
                    ).toFloat(), 1f
            )
            R.styleable.FastTextCommonStyleDef_android_drawablePadding -> compoundDrawablePadding =
                    a.getDimensionPixelSize(attr, 0)
            R.styleable.FastTextCommonStyleDef_android_textColorHint -> setHintTextColor(
                    a.getColor(
                            attr,
                            0
                    )
