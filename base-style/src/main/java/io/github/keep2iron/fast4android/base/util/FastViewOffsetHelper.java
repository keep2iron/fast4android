 ...
 * offsets.
 */
public class FastViewOffsetHelper {
  ...
  public FastViewOffsetHelper(View view) {
    mView = view;
  }
  ...
  /**
   * Set the top and bottom offset for this {@link FastViewOffsetHelper}'s view.
   *
  ...
  /**
   * Set the left and right offset for this {@link FastViewOffsetHelper}'s view.
   *
   * @param offset the offset in px.
   * @return true if the offset has changed
   */
