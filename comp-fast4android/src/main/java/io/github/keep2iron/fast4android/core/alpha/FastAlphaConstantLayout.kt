...
class FastAlphaConstantLayout @JvmOverloads constructor(
  context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : ConstraintLayout(context, attrs, defStyleAttr), IFastLayout {

  private val fastAlphaViewHelper by lazy(LazyThreadSafetyMode.NONE) {
