...
import io.github.keep2iron.fast4android.base.util.FastDisplayHelper;
...
public class FastLoadingView extends View {
  ...
  public FastLoadingView(Context context, AttributeSet attrs) {
    this(context, attrs, R.attr.FastLoadingStyle);
  }

  public FastLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  public FastLoadingView(Context context, int size, int color) {
    super(context);
    mSize = size;
    mPaintColor = color;
    initPaint();
