...
private val APPCOMPAT_CHECK_ATTRS = intArrayOf(androidx.appcompat.appcompat.R.attr.colorPrimary)
...
//    if (viewParent != null) {
//      var layout = viewParent
//      while (layout != null) {
//        if (layout is QMUIPullRefreshLayout) {
//          (layout as QMUIPullRefreshLayout).openSafeDisallowInterceptTouchEvent()
//        }
