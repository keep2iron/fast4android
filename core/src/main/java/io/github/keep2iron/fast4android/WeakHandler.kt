...
class WeakHandler {
  ...
  @VisibleForTesting internal val mRunnables = ChainedRef(mLock, null)
  ...
  constructor(callback: Callback?) {
    ...
    mExec = ExecHandler(WeakReference<Callback>(callback)) // Weak referencing inside ExecHandler
  }
  ...
  class ChainedRef(var lock: Lock, val runnable: Runnable?) {
    ...
    val wrapper: WeakRunnable = WeakRunnable(WeakReference<Runnable>(runnable), WeakReference<ChainedRef>(this))
