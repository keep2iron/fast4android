...
import io.github.keep2iron.fast4android.layout.FastLayoutHelper
import io.github.keep2iron.fast4android.layout.IFastLayout
...
open class FastAlphaFrameLayout @JvmOverloads constructor(
  ...
  private val fastLayoutHelper: FastLayoutHelper =
    FastLayoutHelper(context, attrs, defStyleAttr, this)
  ...
  @FloatRange(from = 0.0, to = 1.0) override fun getShadowAlpha(): Float =
