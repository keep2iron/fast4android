...
fun View.slideOut(
  ...
  listener: Animation.AnimationListener? = null,
  isNeedAnimation: Boolean = true,
  direction: io.github.keep2iron.fast4android.core.util.FastAnimDirection = io.github.keep2iron.fast4android.core.util.FastAnimDirection.RIGHT_TO_LEFT
): TranslateAnimation? {
  if (isNeedAnimation) {
    var translate: TranslateAnimation? = null
    when (direction) {
      io.github.keep2iron.fast4android.core.util.FastAnimDirection.LEFT_TO_RIGHT -> translate = TranslateAnimation(
        Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, 1f,
        Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, 0f
      )
      io.github.keep2iron.fast4android.core.util.FastAnimDirection.TOP_TO_BOTTOM -> translate = TranslateAnimation(
        Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, 0f,
        Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, 1f
      )
      io.github.keep2iron.fast4android.core.util.FastAnimDirection.RIGHT_TO_LEFT -> translate = TranslateAnimation(
        Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, -1f,
        Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, 0f
      )
      io.github.keep2iron.fast4android.core.util.FastAnimDirection.BOTTOM_TO_TOP -> translate = TranslateAnimation(
        Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, 0f,
        Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, -1f
      )
    }
...
fun View.slideIn(
  ...
  listener: Animation.AnimationListener? = null,
  isNeedAnimation: Boolean = true,
  direction: io.github.keep2iron.fast4android.core.util.FastAnimDirection = io.github.keep2iron.fast4android.core.util.FastAnimDirection.LEFT_TO_RIGHT
): TranslateAnimation? {
  if (isNeedAnimation) {
    var translate: TranslateAnimation? = null
    when (direction) {
...
//  }
  ...
  fun getDescendantRect(parent: ViewGroup, descendant: View, out: Rect) {
    ...
    ViewExt.ViewGroupHelper.offsetDescendantRect(
      parent,
      descendant,
      out
    )
