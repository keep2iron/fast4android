...
import io.github.keep2iron.fast4android.FastLogger
import java.io.File
  ...
  init {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
      ...
      try {
        ...
        FastLogger.printErrStackTrace(TAG, e, "read file error")
      } finally {
//        QMUILangHelper.close(fileInputStream)
    ...
    try {
      ...
      FastLogger.printErrStackTrace(TAG, e, "read SystemProperties error")
    }
