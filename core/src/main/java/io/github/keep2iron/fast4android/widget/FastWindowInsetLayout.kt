...
import io.github.keep2iron.fast4android.alpha.FastAlphaFrameLayout
import io.github.keep2iron.fast4android.util.FastWindowInsetHelper
...
open class FastWindowInsetLayout @JvmOverloads constructor(
  ...
  defStyleAttr: Int = 0
) : FastAlphaFrameLayout(context, attrs, defStyleAttr), IWindowInsetLayout {
  protected var mQMUIWindowInsetHelper: FastWindowInsetHelper = FastWindowInsetHelper(this, this)
