...
public final class SpanBuilder {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setLineHeight(@IntRange(from = 0) final int lineHeight, @Align final int align) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setQuoteColor(@ColorInt final int color, @IntRange(from = 1) final int stripeWidth, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setLeadingMargin(@IntRange(from = 0) final int first, @IntRange(from = 0) final int rest) {
        this.first = first;
        this.rest = rest;
        return this;
    }
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setBullet(@ColorInt final int color, @IntRange(from = 0) final int radius, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(final Bitmap bitmap) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(final Bitmap bitmap, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(final Drawable drawable) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(final Drawable drawable, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(final Uri uri) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(final Uri uri, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(@DrawableRes final int resourceId) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setIconMargin(@DrawableRes final int resourceId, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setFontSize(@IntRange(from = 0) final int size, final boolean isDp) {
        this.fontSize = size;
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setFontProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setFontXProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setAlign(@NonNull final Alignment alignment) {
     ...
     * @return {@link SpanBuilder}
     */
    public SpanBuilder setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius, final Blur style) {
