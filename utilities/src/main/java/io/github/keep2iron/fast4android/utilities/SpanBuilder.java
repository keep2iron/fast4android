...
public final class SpanBuilder {
   ...
   */
  public SpanBuilder setQuoteColor(@ColorInt final int color,
      @IntRange(from = 1) final int stripeWidth, @IntRange(from = 0) final int gapWidth) {
   ...
   * @return {@link SpanBuilder}
   */
  public SpanBuilder setBullet(@ColorInt final int color, @IntRange(from = 0) final int radius,
   ...
   * @return {@link SpanBuilder}
   */
  public SpanBuilder setIconMargin(final Bitmap bitmap, final int gapWidth,
      @Align final int align) {
   ...
   * @return {@link SpanBuilder}
   */
  public SpanBuilder setIconMargin(final Drawable drawable, final int gapWidth,
      @Align final int align) {
   ...
   * @return {@link SpanBuilder}
   */
  public SpanBuilder setIconMargin(@DrawableRes final int resourceId, final int gapWidth,
      @Align final int align) {
   ...
   * @return {@link SpanBuilder}
   */
  public SpanBuilder setFontProportion(
      @FloatRange(from = 0, fromInclusive = false) final float proportion) {
   ...
   * @return {@link SpanBuilder}
   */
  public SpanBuilder setFontXProportion(
      @FloatRange(from = 0, fromInclusive = false) final float proportion) {
  ...
  private void updateCharCharSequence() {
    ...
    if (bulletColor != COLOR_DEFAULT) {
      mBuilder.setSpan(new CustomBulletSpan(bulletColor, bulletRadius, bulletGapWidth), start, end,
          flag);
    }
    if (iconMarginGapWidth != -1) {
      if (iconMarginBitmap != null) {
        mBuilder.setSpan(
            new CustomIconMarginSpan(iconMarginBitmap, iconMarginGapWidth, alignIconMargin), start,
            end, flag);
      } else if (iconMarginDrawable != null) {
        mBuilder.setSpan(
            new CustomIconMarginSpan(iconMarginDrawable, iconMarginGapWidth, alignIconMargin),
            start, end, flag);
      } else if (iconMarginUri != null) {
        mBuilder.setSpan(
            new CustomIconMarginSpan(iconMarginUri, iconMarginGapWidth, alignIconMargin), start,
            end, flag);
      } else if (iconMarginResourceId != -1) {
        mBuilder.setSpan(
            new CustomIconMarginSpan(iconMarginResourceId, iconMarginGapWidth, alignIconMargin),
            start, end, flag);
      }
    }
    if (fontSize != -1) {
  ...
  class CustomIconMarginSpan implements LeadingMarginSpan, android.text.style.LineHeightSpan {
    ...
    private CustomIconMarginSpan(final Drawable drawable, final int pad,
